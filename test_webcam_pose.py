    ...
    while True:
        ...
        for person in person_detections:
            ...
            if pose_result.get('success'):
                behavior['head_orientation'] = pose_result.get('head_orientation')
            ...
            if pose_result.get('success'):
                ...
                if face_region:
                    ...
                    radius_px = int(face_region['radius'] * min(bbox_width, bbox_height))
                    radius_px = max(radius_px, 1)
                    cv2.circle(annotated_frame, (cx, cy), radius_px, (255, 255, 0), 2)
                ...
                if hand_metrics:
                    ...
                    for side, base_color in [('left', (0, 255, 255)), ('right', (255, 0, 255))]:
                        ...
                        near_object = hand_behavior.get('near_object') if hand_behavior else False
                        ...
                        size = 12 if near_object else (10 if entry.get('near_face') else 8)
                        thickness = -1 if (entry.get('near_face') or near_object) else 2
                        
                        cv2.circle(annotated_frame, (hx, hy), size, color, thickness)
            ...
            if show_metrics:
                ...
                for j, text in enumerate(metrics_text):
                    ...
                    text_color = risk_color if "Risk:" in text else (255, 255, 255)
        ...
        if frame_count % 30 == 0:
            ...
            if elapsed > 0:
                ...
                print(f"Frame {frame_count} | People: {len(person_detections)} | FPS: {fps:.1f}")
